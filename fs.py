...
authorized_apps_url = "http://192.168.192.118:3000/api/authorized_apps"
...
def report_incidence(file):
    ...
    print(uuuid)
    requests.post(url="http://192.168.192.118:3000/api/incidents", data=data)
...
class GUIWithTK:
    ...
    def block_with_tkinter(self, file):
        ...
        warning_text.place(relx=0.5, rely=0.15, anchor=CENTER)
    ...
    def change(self, *args):
        if args[0] == "Other":
            ...
            if response.status_code == 200:
                ...
                print(f"LOCAL HASH: {clean_local_hash}")
                print(f"SERVER HASH: {clean_server_hash}")
